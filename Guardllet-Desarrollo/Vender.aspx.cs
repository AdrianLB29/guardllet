    ...
    public partial class Vender : System.Web.UI.Page
    {
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection Conexion = new SqlConnection(StringConexion))
                ...
                {
                    Conexion.Open();
                    SqlCommand cmd = new SqlCommand("UPDATE MONEDERO Set SALDO = " + st +" where CODIGO = 'IPN00020151302790000'", Conexion); //update MONEDERO SET SALDO = " + Convert.ToInt16(st)  + "  WHERE CODIGO = '" + tbNoMenedero.Text + "'", Conexion
                    cmd.ExecuteNonQuery();
