...
<body>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 margen">
                    <div class="saldo">
                        ...
                        <div class="fila3">
                            <p id="ultima">Ultima recarga:
                                <asp:Label ID="Lb_Fecha" runat="server" Text="No disponible"></asp:Label>
                            </p>
                        </div>
                        <div class="fila4">
    ...
    <footer>
        ...
        <div class="sociales">
            <button type="button" id="SocialesFacebook" onclick="location.href='https://www.facebook.com/Guardllet-2456917694318846/'" target="_blank"><span class="icon-facebook"></span></button>
            <button type="button" id="SocialesTwitter" onclick="location.href='https://twitter.com/guardllet'" target="_blank"><span class="icon-twitter"></span></button>
            <button type="button" id="SocialesInstagram" onclick="location.href='https://www.instagram.com/guardllet_v13/'" target="_blank"><span class="icon-instagram"></span></button>
        </div>
    </footer>
